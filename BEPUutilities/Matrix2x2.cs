...
namespace BEPUutilities
{
    ...
    public struct Matrix2x2
    {
        ...
        public Matrix2x2(Fix m11, Fix m12, Fix m21, Fix m22)
        {
            M11 = m11;
            M12 = m12;
            M21 = m21;
        ...
        public static void CreateScale(Fix scale, out Matrix2x2 matrix)
        {
            matrix.M11 = scale;
            matrix.M22 = scale;
        ...
        {
            Fix determinantInverse = F64.C1.Div(((matrix.M11.Mul(matrix.M22)).Sub(matrix.M12.Mul(matrix.M21))));
            Fix m11 = matrix.M22.Mul(determinantInverse);
            Fix m12 = (matrix.M12.Neg()).Mul(determinantInverse);

            Fix m21 = (matrix.M21.Neg()).Mul(determinantInverse);
            Fix m22 = matrix.M11.Mul(determinantInverse);
        ...
        {
            Fix resultM11 = (a.M11.Mul(b.M11)).Add(a.M12.Mul(b.M21));
            Fix resultM12 = (a.M11.Mul(b.M12)).Add(a.M12.Mul(b.M22));

            Fix resultM21 = (a.M21.Mul(b.M11)).Add(a.M22.Mul(b.M21));
            Fix resultM22 = (a.M21.Mul(b.M12)).Add(a.M22.Mul(b.M22));
        ...
        {
            result.M11 = ((a.M11.Mul(b.M11)).Add(a.M12.Mul(b.M21))).Add(a.M13.Mul(b.M31));
            result.M12 = ((a.M11.Mul(b.M12)).Add(a.M12.Mul(b.M22))).Add(a.M13.Mul(b.M32));

            result.M21 = ((a.M21.Mul(b.M11)).Add(a.M22.Mul(b.M21))).Add(a.M23.Mul(b.M31));
            result.M22 = ((a.M21.Mul(b.M12)).Add(a.M22.Mul(b.M22))).Add(a.M23.Mul(b.M32));
        }
        ...
        public static void Transform(ref Vector2 v, ref Matrix2x2 matrix, out Vector2 result)
        {
            ...
            result = new Vector2();
#endif
            result.X = (vX.Mul(matrix.M11)).Add(vY.Mul(matrix.M21));
            result.Y = (vX.Mul(matrix.M12)).Add(vY.Mul(matrix.M22));
        }
        ...
        {
            return (M11.Mul(M22)).Sub(M12.Mul(M21));
        }
    }
}