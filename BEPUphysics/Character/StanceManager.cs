...
namespace BEPUphysics.Character
{
    ...
    public class StanceManager
    {
        ...
        public StanceManager(Cylinder characterBody, Fix crouchingHeight, Fix proneHeight, QueryManager queryManager, SupportFinder supportFinder)
        {
        ...
        public bool CheckTransition(Stance targetStance, out Fix newHeight, out Vector3 newPosition)
        {
            ...
            if (CurrentStance != targetStance)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        Fix lowestBound = F64.C0;
                        Fix originalHighestBound = (targetHeight.Sub(currentHeight)).Mul(F64.C0p5.Neg());
                        Fix highestBound = originalHighestBound;
                        Fix currentOffset = F64.C0;
        ...
        bool IsSupportContactObstructive(ref ContactData contact)
        {
            ...
            foreach (var c in SupportFinder.Supports)
            {
                ...
                Fix dot = Vector3.Dot(contact.Normal, c.Contact.Normal);
                Fix depth = (dot.Mul(c.Contact.PenetrationDepth)).Add(Toolbox.BigEpsilon);
        ...
        CharacterContactPositionState TrySupportLocation(ConvexCollidable<CylinderShape> queryObject, ref Vector3 position, out Fix hintOffset,
