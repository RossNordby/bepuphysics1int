...
namespace BEPUphysics.Character
{
    ...
    public class HorizontalMotionConstraint : SolverUpdateable
    {
        ...
        public Vector2 MovementDirection
        {
            ...
            set
            {
                if (movementDirection.X != value.X || movementDirection.Y != value.Y) //Fix32ing point comparison is perfectly fine here. Any bitwise variation should go through.
                {
                    ...
                    {
                        Vector2.Divide(ref value, Fix32Ext.Sqrt(lengthSquared), out movementDirection);
                    }
                    else
                    {
        ...
        /// </summary>
        public Fix MaximumAccelerationForce { get; set; }
        Fix maxForceDt;
        Fix maxAccelerationForceDt;

        private Fix timeUntilPositionAnchor = .2m.ToFix();
        ...
        /// </summary>
        public Fix TimeUntilPositionAnchor
        {
        ...
        /// </summary>
        public Fix PositionAnchorDistanceThreshold { get; set; }
        ...
        public void UpdateMovementBasis(ref Vector3 forward)
        {
            ...
            Fix forwardLengthSquared = horizontalForwardDirection.LengthSquared();
            ...
            {
                Vector3.Divide(ref horizontalForwardDirection, Fix32Ext.Sqrt(forwardLengthSquared), out horizontalForwardDirection);
        ...
        public HorizontalMotionConstraint(Entity characterBody, SupportFinder supportFinder)
        {
            ...
            MaximumAccelerationForce = Fix.MaxValue;
        }
        ...
        public override void Update(Fix dt)
        {
            ...
            if (MovementMode != MovementMode.Floating)
            {
                ...
                else
                {
                    ...
                    Fix length = linearJacobianA1.LengthSquared();
                    ...
                    Vector3.Divide(ref linearJacobianA1, Fix32Ext.Sqrt(length), out linearJacobianA1);
        ...
        public override void ExclusiveUpdate()
        {
            ...
            Vector3 torque;
#endif
            Fix x = accumulatedImpulse.X;
            Fix y = accumulatedImpulse.Y;
...
x.Mul(supportForceFactor);
        ...
        public override Fix SolveIteration()
        {
            ...
            else
            {
                ...
                {
                    Vector2.Multiply(ref accumulatedImpulse, maxForceDt.Div(Fix32Ext.Sqrt(length)), out accumulatedImpulse);
                }
