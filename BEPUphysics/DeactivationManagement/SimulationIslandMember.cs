...
namespace BEPUphysics.DeactivationManagement
{
    ...
    public class SimulationIslandMember
    {
        ...
        Entity owner;
		Fix previousVelocity;
        internal Fix velocityTimeBelowLimit;
        ...
        public void UpdateDeactivationCandidacy(Fix dt)
        {
            //Get total velocity, and see if the entity is losing energy.
            Fix velocity = owner.linearVelocity.LengthSquared().Add(owner.angularVelocity.LengthSquared());
