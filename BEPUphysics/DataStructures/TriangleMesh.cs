...
namespace BEPUphysics.DataStructures
{
    ...
    public class TriangleMesh
    {
        ...
        {
            return RayCast(ray, Fix32.MaxValue, TriangleSidedness.DoubleSided, out rayHit);
        }
        ...
        {
            return RayCast(ray, Fix32.MaxValue, sidedness, out rayHit);
        }
        ...
        {
            return RayCast(ray, Fix32.MaxValue, TriangleSidedness.DoubleSided, hits);
        }
        ...
        {
            return RayCast(ray, Fix32.MaxValue, sidedness, hits);
        }
        ...
        ///<param name="rayHit">Hit data for the ray, if any.</param>
        ///<returns>Whether or not the ray hit the mesh.</returns>
        public bool RayCast(Ray ray, Fix32 maximumLength, out RayHit rayHit)
        {
        ...
        ///<param name="hits">Hit data for the ray, if any.</param>
        ///<returns>Whether or not the ray hit the mesh.</returns>
        public bool RayCast(Ray ray, Fix32 maximumLength, IList<RayHit> hits)
        {
        ...
        ///<param name="hits">Hit data for the ray, if any.</param>
        ///<returns>Whether or not the ray hit the mesh.</returns>
        public bool RayCast(Ray ray, Fix32 maximumLength, TriangleSidedness sidedness, IList<RayHit> hits)
        {
