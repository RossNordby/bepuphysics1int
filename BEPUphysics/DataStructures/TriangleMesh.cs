...
namespace BEPUphysics.DataStructures
{
    ...
    public class TriangleMesh
    {
        ...
        {
            return RayCast(ray, Fix.MaxValue, TriangleSidedness.DoubleSided, out rayHit);
        }
        ...
        {
            return RayCast(ray, Fix.MaxValue, sidedness, out rayHit);
        }
        ...
        {
            return RayCast(ray, Fix.MaxValue, TriangleSidedness.DoubleSided, hits);
        }
        ...
        {
            return RayCast(ray, Fix.MaxValue, sidedness, hits);
        }
        ...
        ///<param name="rayHit">Hit data for the ray, if any.</param>
        ///<returns>Whether or not the ray hit the mesh.</returns>
        public bool RayCast(Ray ray, Fix maximumLength, out RayHit rayHit)
        {
        ...
        ///<param name="rayHit">Hit data for the ray, if any.</param>
        ///<returns>Whether or not the ray hit the mesh.</returns>
        public bool RayCast(Ray ray, Fix maximumLength, TriangleSidedness sidedness, out RayHit rayHit)
        {
            var rayHits = CommonResources.GetRayHitList();
        ...
        ///<param name="hits">Hit data for the ray, if any.</param>
        ///<returns>Whether or not the ray hit the mesh.</returns>
        public bool RayCast(Ray ray, Fix maximumLength, IList<RayHit> hits)
        {
        ...
        ///<param name="hits">Hit data for the ray, if any.</param>
        ///<returns>Whether or not the ray hit the mesh.</returns>
        public bool RayCast(Ray ray, Fix maximumLength, TriangleSidedness sidedness, IList<RayHit> hits)
        {
