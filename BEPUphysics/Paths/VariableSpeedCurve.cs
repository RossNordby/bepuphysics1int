...
namespace BEPUphysics.Paths
{
    ...
    public abstract class VariableSpeedCurve<TValue> : SpeedControlledCurve<TValue>
    {
        ...
        protected VariableSpeedCurve(Path<Fix> speedCurve, Curve<TValue> curve)
            : base(curve)
        {
        ...
        protected VariableSpeedCurve(Path<Fix> speedCurve, Curve<TValue> curve, int sampleCount)
        ...
        /// </summary>
        public Path<Fix> SpeedCurve { get; set; }
        ...
        public override Fix GetSpeedAtCurveTime(Fix time)
        {
