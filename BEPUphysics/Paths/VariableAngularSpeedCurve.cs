...
namespace BEPUphysics.Paths
{
    ...
    public class VariableAngularSpeedCurve : VariableSpeedCurve<Quaternion>
    {
        ...
        public VariableAngularSpeedCurve(Path<Fix> speedCurve, Curve<Quaternion> curve)
        ...
        public VariableAngularSpeedCurve(Path<Fix> speedCurve, Curve<Quaternion> curve, int sampleCount)
            : base(speedCurve, curve, sampleCount)
        {
        }

        protected override Fix GetDistance(Quaternion start, Quaternion end)
        {
