...
namespace BEPUphysics.Constraints.TwoEntity.JointLimits
{
    ...
    public class SwingLimit : JointLimit, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        private Fix minimumCosine = F64.C1;
        private Fix error;
        ...
        public SwingLimit(Entity connectionA, Entity connectionB, Vector3 axisA, Vector3 axisB, Fix maximumAngle)
        {
        ...
        {
            get { return Fix32Ext.Acos(minimumCosine); }
            set { minimumCosine = Fix32Ext.Cos(MathHelper.Clamp(value, F64.C0, MathHelper.Pi)); }
        }
...
lambda.Mul(velocityToImpulse);
        ...
        public override void Update(Fix dt)
        {
            ...
            Fix lengthSquared = hingeAxis.LengthSquared();
