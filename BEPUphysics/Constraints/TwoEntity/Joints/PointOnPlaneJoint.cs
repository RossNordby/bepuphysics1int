...
namespace BEPUphysics.Constraints.TwoEntity.Joints
{
    ...
    public class PointOnPlaneJoint : Joint, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        private Fix negativeEffectiveMass;
        private Vector3 rA;
        ...
        public override Fix SolveIteration()
        {
            ...
            Fix lambda = negativeEffectiveMass.Mul(((velocityDifference.Add(biasVelocity)).Add(softness.Mul(accumulatedImpulse))));
        ...
        public override void Update(Fix dt)
        {
            ...
            Fix pointDistance, planeDistance;
            ...
            Fix distanceChange = planeDistance.Sub(pointDistance);
