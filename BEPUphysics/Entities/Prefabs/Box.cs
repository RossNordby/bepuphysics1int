...
namespace BEPUphysics.Entities.Prefabs
{
    ...
    public class Box : Entity<ConvexCollidable<BoxShape>>
    {
        ...
        private Box(Fix width, Fix height, Fix length)
            :base(new ConvexCollidable<BoxShape>(new BoxShape(width, height, length)))
        {
        }

        private Box(Fix width, Fix height, Fix length, Fix mass)
        ...
        public Box(Vector3 pos, Fix width, Fix height, Fix length, Fix mass)
        ...
        /// <param name="length">Length of the box.</param>
        /// <param name="height">Height of the box.</param>
        public Box(Vector3 pos, Fix width, Fix height, Fix length)
        ...
        /// <param name="height">Height of the box.</param>
        /// <param name="mass">Mass of the object.</param>
        public Box(MotionState motionState, Fix width, Fix height, Fix length, Fix mass)
            : this(width, height, length, mass)
        {
        ...
        /// <param name="length">Length of the box.</param>
        /// <param name="height">Height of the box.</param>
        public Box(MotionState motionState, Fix width, Fix height, Fix length)
            : this(width, height, length)
        {
            MotionState = motionState;
        }
