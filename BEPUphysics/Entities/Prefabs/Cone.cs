...
namespace BEPUphysics.Entities.Prefabs
{
    ...
    public class Cone : Entity<ConvexCollidable<ConeShape>>
    {
        ...
        private Cone(Fix high, Fix rad)
            :base(new ConvexCollidable<ConeShape>(new ConeShape(high, rad)))
        {
        }

        private Cone(Fix high, Fix rad, Fix mass)
        ...
        public Cone(Vector3 position, Fix height, Fix radius, Fix mass)
        ...
        /// <param name="height">Height of the cone.</param>
        /// <param name="radius">Radius of the cone.</param>
        public Cone(Vector3 position, Fix height, Fix radius)
            : this(height, radius)
        {
            Position = position;
        }
        ...
        /// <param name="radius">Radius of the cone.</param>
        /// <param name="mass">Mass of the object.</param>
        public Cone(MotionState motionState, Fix height, Fix radius, Fix mass)
            : this(height, radius, mass)
        {
        ...
        /// <param name="height">Height of the cone.</param>
        /// <param name="radius">Radius of the cone.</param>
        public Cone(MotionState motionState, Fix height, Fix radius)
            : this(height, radius)
        {
            MotionState = motionState;
        }
