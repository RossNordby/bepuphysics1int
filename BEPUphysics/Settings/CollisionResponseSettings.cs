...
namespace BEPUphysics.Settings
{
    ...
    public static class CollisionResponseSettings
    {
        ...
        /// Defaults to 1.
        /// </summary>
        public static Fix BouncinessVelocityThreshold = F64.C1;

        /// <summary>
        /// Maximum speed at which interpenetrating objects will attempt to undo any overlap.
        /// Defaults to 2.
        /// </summary>
        public static Fix MaximumPenetrationRecoverySpeed = F64.C2;

        /// <summary>
        /// Fraction of position error to convert into corrective momentum.
        /// Defaults to 0.2.
        /// </summary>
        public static Fix PenetrationRecoveryStiffness = 0.2m.ToFix();
        ...
        /// </summary>
        public static Fix Softness = .001m.ToFix();
