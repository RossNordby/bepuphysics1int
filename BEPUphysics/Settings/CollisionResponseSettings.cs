...
namespace BEPUphysics.Settings
{
    ...
    public static class CollisionResponseSettings
    {
        ...
        /// Defaults to 0.2.
        /// </summary>
        public static Fix32 PenetrationRecoveryStiffness = 0.2m.ToFix();
        ...
        /// </summary>
        public static Fix32 Softness = .001m.ToFix();
