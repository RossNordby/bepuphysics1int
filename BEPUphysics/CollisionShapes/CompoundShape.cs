...
namespace BEPUphysics.CollisionShapes
{
    ...
    public struct CompoundShapeEntry
    {
        ...
        public CompoundShapeEntry(EntityShape shape, RigidTransform localTransform, Fix weight)
        {
        ...
        public CompoundShapeEntry(EntityShape shape, Vector3 position, Fix weight)
        {
            position.Validate();
        ...
        ///<param name="weight">Weight of the entry.  This defines how much the entry contributes to its owner
        /// for the purposes of center of rotation computation.</param>
        public CompoundShapeEntry(EntityShape shape, Quaternion orientation, Fix weight)
        {
        ...
        ///<param name="weight">Weight of the entry.  This defines how much the entry contributes to its owner
        /// for the purposes of center of rotation computation.</param>
        public CompoundShapeEntry(EntityShape shape, Fix weight)
        {
    ...
    public class CompoundShape : EntityShape
    {
        ...
        public static void ComputeVolumeDistribution(IList<CompoundShapeEntry> entries, out Fix volume, out Matrix3x3 volumeDistribution, out Vector3 center)
        {
            center = new Vector3();
            ...
            Fix totalWeightInverse = F64.C1.Div(totalWeight);
        ...
        public static void TransformContribution(ref RigidTransform transform, ref Vector3 center, ref Matrix3x3 baseContribution, Fix weight, out Matrix3x3 contribution)
        {
            Matrix3x3 rotation;
