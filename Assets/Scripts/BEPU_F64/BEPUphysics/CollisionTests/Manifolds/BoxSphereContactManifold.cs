...
namespace BEPUphysics.CollisionTests.Manifolds
{
    ...
    public class BoxSphereContactManifold : ContactManifold
    {
        ...
        public override void Update(Fix32 dt)
        {
            ...
            {
                if (!previouslyColliding && contactData.PenetrationDepth >= Fix32.Zero)//Don't use the contact if it's an initial contact and the depth is negative.  Why not? Bounciness and InitialCollisionDetected.
                {
                    Add(ref contactData);
                    colliding = true;
                }
