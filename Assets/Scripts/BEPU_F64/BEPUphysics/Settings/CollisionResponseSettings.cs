...
namespace BEPUphysics.Settings
{
    ...
    public static class CollisionResponseSettings
    {
        ...
        /// Defaults to 1.
        /// </summary>
        public static Fix32 BouncinessVelocityThreshold = F64.C1;

        /// <summary>
        /// Maximum speed at which interpenetrating objects will attempt to undo any overlap.
        /// Defaults to 2.
        /// </summary>
        public static Fix32 MaximumPenetrationRecoverySpeed = F64.C2;

        /// <summary>
        /// Fraction of position error to convert into corrective momentum.
        /// Defaults to 0.2.
        /// </summary>
        public static Fix32 PenetrationRecoveryStiffness = 0.2m.ToFix32();
        ...
        /// Defaults to 0.2.
        /// </summary>
        public static Fix32 StaticFrictionVelocityThreshold = 0.2m.ToFix32();

        /// <summary>
        /// Value by which a collision pair's friction coefficient will be multiplied to get the twist friction coefficient.
        /// Defaults to 1.
        /// </summary>
        public static Fix32 TwistFrictionFactor = 1m.ToFix32();
        ...
        /// </summary>
        public static Fix32 Softness = .001m.ToFix32();
