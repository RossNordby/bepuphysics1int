...
namespace BEPUphysics.Entities
{
    ...
    public class MorphableEntity : Entity
    {
        ...
        public MorphableEntity(EntityCollidable collisionInformation, Fix32 mass)
        ...
        public MorphableEntity(EntityCollidable collisionInformation, Fix32 mass, Matrix3x3 inertiaTensor)
        ...
        ///<param name="shape">Shape to use with the entity.</param>
        ///<param name="mass">Mass of the entity.</param>
        public MorphableEntity(EntityShape shape, Fix32 mass)
            : base(shape, mass)
        {
        }
        ...
        ///<param name="mass">Mass of the entity.</param>
        /// <param name="inertiaTensor">Inertia tensor of the entity.</param>
        public MorphableEntity(EntityShape shape, Fix32 mass, Matrix3x3 inertiaTensor)
        ...
        public void SetCollisionInformation(EntityCollidable newCollisionInformation, Fix32 newMass)
        {
            //Temporarily remove the object from the space.  
            //The reset process will update any systems that need to be updated.
            //This is not thread safe, but this operation should not be performed mid-frame anyway.
        ...
        public void SetCollisionInformation(EntityCollidable newCollisionInformation, Fix32 newMass, Matrix3x3 newInertia)
        {
            //Temporarily remove the object from the space.  
            //The reset process will update any systems that need to be updated.
            //This is not thread safe, but this operation should not be performed mid-frame anyway.
