...
namespace BEPUphysics.Constraints.TwoEntity.Joints
{
    ...
    public class PointOnPlaneJoint : Joint, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        private Fix32 negativeEffectiveMass;
        private Vector3 rA;
        ...
        public override Fix32 SolveIteration()
        {
            ...
            Fix32 lambda = negativeEffectiveMass .Mul (velocityDifference .Add (biasVelocity) .Add (softness .Mul (accumulatedImpulse)));
        ...
        public override void Update(Fix32 dt)
        {
            ...
            Fix32 pointDistance, planeDistance;
            ...
            Fix32 distanceChange = planeDistance .Sub (pointDistance);
            ...
            if (connectionA.IsDynamic && connectionB.IsDynamic)
            {
                ...
                negativeEffectiveMass = Fix32.MinusOne .Div (negativeEffectiveMass .Add (softness));
            }
            ...
            else if (!connectionA.IsDynamic && connectionB.IsDynamic)
            {
                ...
                negativeEffectiveMass = Fix32.Zero;
