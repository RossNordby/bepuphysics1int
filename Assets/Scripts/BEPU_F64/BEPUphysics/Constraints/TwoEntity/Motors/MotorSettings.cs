...
namespace BEPUphysics.Constraints.TwoEntity.Motors
{
    ...
    public abstract class MotorSettings
    {
        ...
        public Fix32 MaximumForce
        {
            ...
            set
            {
                value = value >= Fix32.Zero ? value : Fix32.Zero;
    ...
    public class ServoSettings : ISpringSettings
    {
        ...
        public Fix32 BaseCorrectiveSpeed
        {
            ...
            set
            {
                value = value < Fix32.Zero ? Fix32.Zero : value;
        ...
        public Fix32 MaxCorrectiveVelocity
        {
            ...
            set
            {
                value = MathHelper.Max(Fix32.Zero, value);
    ...
    public class VelocityMotorSettings
    {
        ...
        /// </summary>
        internal Fix32 softness = .0001m.ToFix32();
