...
namespace BEPUphysics.Paths
{
    ...
    public abstract class VariableSpeedCurve<TValue> : SpeedControlledCurve<TValue>
    {
        ...
        protected VariableSpeedCurve(Path<Fix32> speedCurve, Curve<TValue> curve)
            : base(curve)
        {
        ...
        protected VariableSpeedCurve(Path<Fix32> speedCurve, Curve<TValue> curve, int sampleCount)
        ...
        /// </summary>
        public Path<Fix32> SpeedCurve { get; set; }
        ...
        public override Fix32 GetSpeedAtCurveTime(Fix32 time)
        {
