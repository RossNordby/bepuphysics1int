...
namespace BEPUphysics.Paths
{
    ...
    public class CardinalSpline3D : HermiteCurve3D
    {
        ...
        {
            get { return tension; }
            set { tension = MathHelper.Clamp(value, Fix32.Zero, F64.C1); }
        }
        ...
        protected override void ComputeTangents()
        {
            ...
            for (int i = 1; i < ControlPoints.Count - 1; i++)
            {
                ...
                Vector3.Multiply(ref tangent, ((F64.C1 .Sub (tension)) .Div (ControlPoints[i + 1].Time .Sub (ControlPoints[i - 1].Time))), out tangent);
